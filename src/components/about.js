...
function Education() {
    return (
        <div className="education">
            ...
            <Typography>
                <ul>
                    <li>2018年4月 - 現在 香川大学大学院 工学研究科 信頼性情報システム工学専攻</li>
                    <ul>
                        <li>安藤研究室所属</li>
                    </ul>
        ...
        <div className="activities">
            ...
            <Typography>
                <ul>
                    ...
                    <li>
                        2018年12月 株式会社任天堂 インターンシップ（ネットワーク開発コース）
                        </li>
                    <li>
                        2018年12月 株式会社サイバーエージェント kubernetes勉強会参加
                            <ul>
                            <li>
                                CKAD(Certified Kubernetes Application Developer)模擬試験1位
                                </li>
                        </ul>
                    </li>
                    <li>
                        2018年9月 株式会社日本経済新聞社 インターンシップ（Webアプリ開発）
                        </li>
                    <li>
...
function Awards() {
    return (
        <div className="awards">
            ...
            <Typography>
                <ul>
                    <li>2019年度 香川大学 特待生</li>
                    <li>2017年度 香川大学 特待生</li>
                </ul>
            </Typography>
        </div>
    );
